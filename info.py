...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/BSHEGDE3')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/BSHEGDE3')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/creationsofficial/3')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'Hello Freinds ❤️')
...
QUALITY = ["240p" , "360p" , "480p" , "576p"  , "720p" , "1080p"]
